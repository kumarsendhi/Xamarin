...
namespace IoTApp
{
    public class OperationInDocumentDb
    {
        ...
        {
            client = new DocumentClient(new System.Uri(accountURL), ConvertToSecureString(accountKey));
        }

        private SecureString ConvertToSecureString(string accountKey)
        {
            if (accountKey == null)
